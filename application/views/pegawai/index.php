                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($data as $key) : ?>
                                        <tr>
                                            ...
                                            <td><?= $key['alamat']; ?></td>
                                            <td>
                                                <button class="btn btn-simple lorem" data-toggle="modal" data-target="#lihatFoto<?= $key['id_pegawai']; ?>"><i class="material-icons">remove_red_eye</i></button>
                                            </td>
                                            <td><?= $key['no_hp']; ?></td>
                                            <td><?= $key['jabatan']; ?></td>
                                            ...
                                            <td class="text-right">
                                                ...
                                                <a href="<?= base_url() ?>pegawai/edit/<?= $key['id_pegawai']; ?>" class="btn btn-simple lorem btn-icon"><i class="material-icons">edit</i></a>



                                                <button class="btn btn-simple lorem btn-icon" data-toggle="modal" data-target="#hapusPegawai<?= $key['id_pegawai']; ?>"><i class="material-icons">close</i></button>
