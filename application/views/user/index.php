                                    ...
                                    <?php foreach ($data as $key) : ?>
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                ...
                                                <a href="<?= base_url() ?>user/edit/<?= $key['id_user']; ?>" class="btn btn-simple lorem btn-icon"><i class="material-icons">edit</i></a>
                                                ...
                                                <button class="btn btn-simple lorem btn-icon" data-toggle="modal" data-target="#hapusUser<?= $key['id_user']; ?>"><i class="material-icons">close</i></button>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form method="post" action="<?= base_url(); ?>user/hapus/<?= $key['id_user']; ?>">
                                            ...
                                            <div class="modal-footer text-center">
                                                ...
                                                <button type="submit" class="btn btn-success lorem">Ya</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
