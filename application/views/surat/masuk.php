							...
							<table id="datatables" class="table table-striped table-no-bordered table-hover"
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<!-- <a href="#" class="btn btn-simple lorem lorem btn-icon like"><i class="material-icons">remove_red_eye</i></a> -->
											<!-- <a href="#" class="btn btn-simple lorem btn-warning btn-icon edit"><i class="material-icons">dvr</i></a>
                                                <a href="#" class="btn btn-simple lorem btn-danger btn-icon remove"><i class="material-icons">close</i></a> -->
											<button class="btn btn-simple lorem lorem" data-toggle="modal"
										...
										<td class="text-right">
											...
											<a href="<?= base_url() ?>surat/editSuratMasuk/<?= $key['id_surat_masuk']; ?>"
												class="btn btn-simple lorem btn-primary btn-icon"><i
													class="material-icons">edit</i></a>
											<button class="btn btn-simple lorem btn-warning btn-icon" data-toggle="modal"
								...
								<div class="modal-content">
									...
									<form method="post"
										...
										<div class="modal-footer text-center">
											<button type="button" class="btn btn-simple lorem"
												data-dismiss="modal">Tidak</button>
											<button type="submit" class="btn btn-success btn-simple lorem">Ya</button>
										</div>
									</form>
								</div>
							</div>
						...
						<div class="modal fade" id="lihatSurat<?= $key['id_surat_masuk']; ?>" tabindex="-1"
							...
							<div class="modal-dialog modal-notice">
								<div class="modal-content">
									...
									<div class="modal-footer text-center">
										<button type="button" class="btn lorem btn-round"
